...
@SuppressLint("NewApi")
public class PieChartRotationAnimatorV14 implements ir.ripz.monify.view.chart.animation.PieChartRotationAnimator, AnimatorListener, AnimatorUpdateListener {
    private final PieChartView chart;
    private ValueAnimator animator;
    private float startRotation = 0;
    private float targetRotation = 0;
    private ir.ripz.monify.view.chart.animation.ChartAnimationListener animationListener = new ir.ripz.monify.view.chart.animation.DummyChartAnimationListener();
