...
public class PieChartRotationAnimatorV8 implements ir.ripz.monify.view.chart.animation.PieChartRotationAnimator {
    ...
    private ir.ripz.monify.view.chart.animation.ChartAnimationListener animationListener = new DummyChartAnimationListener();
