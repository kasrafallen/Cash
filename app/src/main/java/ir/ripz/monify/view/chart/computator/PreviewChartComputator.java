package ir.ripz.monify.view.chart.computator;

import ir.ripz.monify.view.chart.computator.*;
 ...
 * preview area.
 */
public class PreviewChartComputator extends ir.ripz.monify.view.chart.computator.ChartComputator {
