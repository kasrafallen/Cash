...
import ir.ripz.monify.view.chart.formatter.*;
import ir.ripz.monify.view.chart.formatter.ValueFormatterHelper;
import ir.ripz.monify.view.chart.model.SliceValue;


public class SimplePieChartValueFormatter implements ir.ripz.monify.view.chart.formatter.PieChartValueFormatter {

    private ir.ripz.monify.view.chart.formatter.ValueFormatterHelper valueFormatterHelper = new ValueFormatterHelper();
