...
import ir.ripz.monify.view.chart.formatter.PieChartValueFormatter;
import ir.ripz.monify.view.chart.formatter.SimplePieChartValueFormatter;
import ir.ripz.monify.view.chart.model.*;
import ir.ripz.monify.view.chart.model.SliceValue;
import ir.ripz.monify.view.chart.view.Chart;
...
public class PieChartData extends AbstractChartData {
    ...
    private List<ir.ripz.monify.view.chart.model.SliceValue> values = new ArrayList<ir.ripz.monify.view.chart.model.SliceValue>();
    ...
    public PieChartData(List<ir.ripz.monify.view.chart.model.SliceValue> values) {
        setValues(values);
    ...
    public PieChartData(PieChartData data) {
        ...
        for (ir.ripz.monify.view.chart.model.SliceValue sliceValue : data.values) {
            this.values.add(new ir.ripz.monify.view.chart.model.SliceValue(sliceValue));
        }
    }
    ...
    public static PieChartData generateDummyData() {
        ...
        List<ir.ripz.monify.view.chart.model.SliceValue> values = new ArrayList<ir.ripz.monify.view.chart.model.SliceValue>(numValues);
        values.add(new ir.ripz.monify.view.chart.model.SliceValue(40f));
        values.add(new ir.ripz.monify.view.chart.model.SliceValue(20f));
        values.add(new ir.ripz.monify.view.chart.model.SliceValue(30f));
        values.add(new ir.ripz.monify.view.chart.model.SliceValue(50f));
    ...
    public void update(float scale) {
        for (ir.ripz.monify.view.chart.model.SliceValue value : values) {
            value.update(scale);
        }
    }
    ...
    public List<ir.ripz.monify.view.chart.model.SliceValue> getValues() {
        return values;
    }

    public PieChartData setValues(List<ir.ripz.monify.view.chart.model.SliceValue> values) {
        if (null == values) {
